  ...
  return (
    <div className="w-full">
      <div className="w-full  flex items-center flex-col">
        <div className="text-3xl h-[7rem] bg-[#e0f4ff] w-full flex justify-center items-center border-b-2">내 진단 결과</div>
        ...
        <div className="w-full pt-10 pb-8 bg-[#e0f4ff] flex justify-center items-center flex-col">
          ...
          <Button text="홈으로가기" width={"90%"} height={"60px"} fontSize={"24px"} onClick={handleSubmit}/>
        </div>
      </div>
    </div>
  )
